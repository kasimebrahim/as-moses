...
#ifndef MOSES_PROGRAM_INTERPRETER_H
#define MOSES_PROGRAM_INTERPRETER_H

#include <opencog/atoms/base/Handle.h>

/**
 * class ProgramInterpreter -- create an unfolded program from compressed program
 *
...
public:
	ProgramInterpreter(opencog::Handle* input_table);
...
#endif //MOSES_PROGRAM_INTERPRETER_H
